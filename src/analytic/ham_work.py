...
def circular_orbit(headless=False):
    #dot(phit-2tht)=0
    ...
    if not headless:
        sympy.pprint(p_phit_soltn_inr)
        mathjaxify(p_phit_soltn_inr)
